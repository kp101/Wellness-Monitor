...
Additional features like environmental sensors(bme68x, bme690), oled display, audio out, camera, plotting, etc. are available for more advanced implementers.
...
> [!TIP]
> The most cost efficient is the RaspberryPi Pico 2W ~ $10 CAD each, plus mmWave ~ $5 CAD, an old phone charger and a mqtt online broker account. Start [here](https://github.com/kp101/Wellness-Monitor/tree/50d20936e2d2d9d425f359b2aec37112ab954b6e/RaspberryPi-Pico2W).

## Advanced Features

These are features not part of the core function and requires additional customizations. See respective project details in subfolders.
...
## Minimum Requirements
  1. Adafruit IO account (not neccesary but sufficient. You can use other MQTT brokers but a commercial broker has features to trigger alarms and send text/email),
