...
1. ![bme68x](https://github.com/kp101/Wellness-Monitor/tree/a29afb64b6e6dd7e5c559bf10b444d1349f239b6/RaspberryPi/bme68x) is an enviornmental monitor, it is for collecting temperature/pressure/humidity and voc and post them into an online MQTT broker;
2. ![listener](https://github.com/kp101/Wellness-Monitor/tree/6c04aa0b26d657ff89895f3c0a0416408bf7a29a/RaspberryPi/listener) is subscriber service. It will take corresponding action based on the arriving payload from a particular topic. e.g. Take a picture, sound an alarm, display environmental data or flash a message of "DOORBELL" (for the hearing impaired);
