...
> [!TIP]
> The most cost efficient is the RaspberryPi Pico 2W ~ $10 CAD, mmWave ~ $5 CAD, plus an old phone charger and an mqtt online broker for remote monitoring. Start [here](RaspberryPi-Pico2W).
