...
4. proximity is a activity sensor. It will send a message to the MQTT broker if someone is present in the room. It can be fooled by a sleeping person or pets.
