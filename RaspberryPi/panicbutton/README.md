...
## Purpose
Pressing a remote button will send a message to a designated mqtt online feed. This online feed will be further directed to recipient via SMS, email. An external listener maybe able to audibily confirm the message has been received by the online MQTT broker. For futher detail, see listener project.
