...
The following is a "C/C++" implementation using a Adafruit ESP32 Feather S2 with embedded bme280 sensor and an optional mmWave sensor. Currently is is coded for remote monitoring of outdoor conditions with a battery pack. There are functions for mmWave left in place but not called.
