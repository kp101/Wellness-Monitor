<b>RASPBERRY PI ZERO 2W + BME68X</b>
...
<b>Attaching Bosch's BME688 sensor over I2C (requires ~3.1 mA):</b>
...
Note: 
. depending on what else is attached to I2C, there is a secondary address for bme688...0x76, use i2cdetect to check. This sensor has a heater, it should have a breakin period and a scan period meeting the requirements of Bosch for accuracy. see Bosch doc.
...
<b>Compiling and Installation Instructions:</b>
